...
{
    public class EfNewsletterSubscriberDal : GenericRepository<NewsletterSubscriber>, INewsletterSubscriberDal
    {
        public EfNewsletterSubscriberDal(BlogContext context) : base(context)
        {
        }
